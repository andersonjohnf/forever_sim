...
| Rage in Cat and caster form | Their power isn't rage | The sim gives no rage from white hits or hits taken outside bear; spell energizes (Furor, Primal Fury, Natural Reaction, a Mighty Rage Potion) still add it | [?] (the sim's model; [druid.md §4.8](../classes/druid.md#48-bear-threat-and-druid-rage-numbers-summary-for-the-shared-docs)) |
