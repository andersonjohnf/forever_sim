...
| Lacerate, Primal Bite (Mangle (Bear) until 1.60.1.70009) | — | New. Lacerate's "high amount of threat": +206 (Forever's Sunder Armor r5's client value) by the [wording table](#threat-wording-table); Primal Bite unknown (dmg × 1) | [F] spells, [?] threat |
...
4. **Bear** [?]: Maul and Swipe multipliers (1.75), Demoralizing Roar (39) and Faerie Fire (108):
   ...
   1.60.1.70009) threat is assumed dmg × 1. Neither is measured. Test: a first Lacerate on a fresh mob
