 ...
 * Protection, the first tank, from P2, the Feral cat from B2, Retribution from C2.
 */
const AVAILABLE: ReadonlySet<SpecId> = new Set(['warrior-fury', 'warrior-arms', 'warrior-protection', 'druid-feral-cat', 'paladin-retribution'])
