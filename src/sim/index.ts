 ...
 * three mages from K2, the Destruction and Affliction warlocks from K3 and Demonology from H3, the Elemental shaman from K5, the
...
const AVAILABLE: ReadonlySet<SpecId> = new Set([
  ...
  'warlock-destruction',
  'warlock-affliction',
  // docs/classes/warlock.md §11: on the pet core (H3).
  'warlock-demonology',
