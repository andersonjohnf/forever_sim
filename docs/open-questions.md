...
| D3 | Rage energize amounts (tenths) | `SpellEffect` · both builds | Bloodrage 2687 = 100 and 29131 = 10 per 1,000 ms for 10 s; Charge 11578 = 150; Mighty Rage Potion 17528 = 600, variance 0.5, 20 s; Shield Specialization 1310318 = 50 (Classic 23602 = 10); Master of Defense → 23602 = 50; Enrage 5229 = 100 + 20/s; Furor 17057 = 100; Blood Frenzy (Primal Fury) 16959 = 50; Natural Reaction 417053 = 50; Heroic Strike 25286 +157 | High · M2 | [rage § sources](mechanics/rage.md#warrior-rage-sources-and-sinks), [§ bear](mechanics/rage.md#bear-druid-rage) | ✅ confirmed from client data, see [client.md](data/client.md#doc-claims-checked-against-the-raw-client) |
