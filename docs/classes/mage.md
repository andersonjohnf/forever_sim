...
| Gnome | Alliance | yes | yes | Expansive Mind (20591): **+5% maximum mana** (aura 178) instead of Classic's +5% Intellect [F]; **Eureka!** (1259817), pressed on cooldown from the pull: the next 3 of Fireball, Scorch, Fire Blast, Frostbolt and Arcane Missiles cost 10% less mana (50% until 1.60.1.70009 made every class's cut 10%) and deal +10% (Fireball's DoT +10%; Arcane Missiles only its cost, its missiles are outside the mask; not Pyroblast) [F] [client] (1.60.1.70009), its rules [?] (`src/sim/classes/eureka.ts`, `eureka`): +0.99% Fire, +0.83% Frost, +0.11% Arcane (Gnome, racial on vs off, the defaults, seed 12345, 20,000 fights; +1.98%, +0.84% and +0.32% at 50%) |
