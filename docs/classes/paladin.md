...
| --- | --- | --- |
| Improved Holy Strike (2), new | "Reduces the cooldown of your Holy Strike ability by 2 sec." | **Removed from the trees in 1.60.1.70009** ([data/talents.md](../data/talents.md#tree-versions)); was Holy Strike CD 10 s |
...
**gains** 45 mana per judgement. A 30 s SoC cycle (one recast, 3.75 judgements, 2.5 Holy
Strikes) costs about 65 mana net ([Worked example 8](#worked-examples)). Ret no longer goes
...
8. **Retribution mana cycle** (Benediction 5/5, Sanctified Judgement 3/3, Improved Judgement
   2/2; Holy Strike every 12 s, Improved Holy Strike having left the trees in 1.60.1.70009,
   [talents.md](../data/talents.md#tree-versions)): Judgement = floor(1512 × 0.06) = 90 → ×0.9 =
   **81**; return 0.6 × 210 = **126** → **+45** per SoC judgement. SoC recast 189. Over 30 s:
   189 + 2.5 × 18 − 3.75 × 45 = **65.25 mana** (2.175 mana/s).
9. **Damage multiplier stack on a white hit** with 2HWS 3/3 and Vengeance 3/3 at 5 stacks (Crusade,
   ×1.02 more, left the trees in 1.60.1.70009): 1.09 × 1.15 = **×1.2535**. On a SoC proc (Holy):
   1.15 (Improved Seals) × 1.15 = **×1.3225**.
