...
export const BEAR_OPTIONS: RotationOption[] = [
  ...
  },
  {
    ...
    help: 'Leave Lacerate out while warriors in the raid (the Buffs tab) keep their Deep Wounds on the boss, which turns on Rend and Tear without it. Its rage then goes to Maul: about 13% less threat and 15% less damage in the default setup, with Lacerate’s “high amount of threat” at 206 an application (untested). Off by default.',
    default: false,
