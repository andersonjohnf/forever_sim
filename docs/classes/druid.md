...
| **Default** (9/42/0, interim gear) | **1,081.9** | **532.6** | 628.9 | 7,038 | 14,608 | 24,903 (90.3%) |
| Default, Max TPS | 1,115.6 | 547.5 | 633.4 | 7,038 | 14,608 | 24,903 |
| Default, Alliance (Night Elf) | 1,108.9 | 542.2 | 616.3 | 6,663 | 14,630 | 23,601 |
...
| Thick Hide (3) | "While in Bear Form, Cat Form, Dire Bear Form, or Moonkin Form, you gain 3 additional base Armor per level and another 2.00 base Armor for each point of defense skill beyond five times your level. This amount can be further increased by multipliers from those forms." [F] [client](../data/client.md#talentsjson) (spell 16929) | A bear's armor: 828 in Dire Bear Form at 3/3 and 300 defense (BR6, §4.7), in its effective health ([optimizer.md](../optimizer.md#constraints)). Armor doesn't move Forever's rage, so the screen finds it lowers damage taken only |
| Feral Swiftness (2) | "Increases your movement speed while in Cat Form by 30%, and increases your chance to Dodge by 4%." [F] [client](../data/client.md#talentsjson) (spell 17002) | The bear's avoidance talent, as Anticipation and Deflection are the warrior's and paladin's (user decision, D30). The sim measures its dodge, and a dodged hit gives no rage, so the screen values it just below zero (−0.99 points on 2026-09-24's default) and a threat-first search drops it, but bears take it. Natural Reaction, whose dodge comes with rage, is left to the search |

The default build (§7.1) already has all three.
