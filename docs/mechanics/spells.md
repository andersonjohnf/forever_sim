...
| **Power Infusion** (10060) | +20% spell damage, 15 s, 3 min cooldown, off the GCD, unchanged | the same | Buffs entry, the casters' and the Protection paladin's, cast on you once at the pull: a caster's rotation presses it ([§12](#12-what-a-class-slice-uses); [buffs](buffs-debuffs-consumables.md#power-infusion)) | [F] [C] [client] (SpellEffect, SpellCooldowns, both builds) |
