...
describe('golden run (fixed config and seed)', () => {
  ...
  //   Mindfang +30, not the Rare rule's extrapolated +94. 565.37 → 538.12 DPS.
  // - EL-2: a Horde caster wears Whiteout Staff (+74 spell power, Frostwolf Clan Revered), which the sim
  //   ranks above Mindfang and the off hand (docs/data/items.md#pre-raid-bis-lists): 538.12 → 539.40 DPS.
