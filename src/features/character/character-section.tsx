  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <RacePicker races={races} selected={selected} onPick={pick} />
      </div>
      ...
      <Advanced>
        ...
        <label className="flex min-h-11 cursor-pointer items-center justify-between gap-4">
          ...
          <Switch
            ...
            aria-describedby="unmeasured-help"
 ...
 */
function RacePicker({ races, selected, onPick }: { races: Race[]; selected: Race; onPick: (race: Race) => void }) {
  const meta = useSpecMeta()
  ...
  return (
    <div role="radiogroup" aria-labelledby="race-label" onKeyDown={onKeyDown} className="flex flex-col gap-4">
