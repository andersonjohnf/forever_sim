...
export const RETRIBUTION_OPTIONS: RotationOption[] = [
  ...
  manaOption(ID.exorcismMana, 'Exorcism from', 'Use it only at or above this much of your maximum mana.', 20, ID.exorcism, 'Core abilities'),
  {
    ...
    group: 'Fillers',
    label: 'Consecration',
    help: 'Put down Consecration (rank 5, 395 mana with the default talents) when you have the mana: 8 ticks of Holy damage over 8 s.',
    default: true,
  },
  manaOption(ID.consecrationMana, 'Consecration from', 'Use rank 5 only at or above this much of your maximum mana.', 40, ID.consecration, 'Fillers'),
  {
    kind: 'toggle',
    id: ID.consecrationRank1,
    group: 'Fillers',
    label: 'Consecration (Rank 1)',
    help: 'Below that, put down rank 1 (94 mana with the default talents). Every rank has the full spell damage bonus, so it’s the most damage for the mana.',
    default: true,
  },
