...
1. **Maelstrom Weapon's chance a hit.** The tooltip describes a chance but never shows it: it
   ...
   user decision (D38, item 26), since zero would contradict the described chance; no allowed source
   states the rate
