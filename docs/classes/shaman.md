...
- **E8: Alliance gear.** The list's honor mail is Horde's, and the client has no Alliance twin a shaman
  ...
  Ironbark Staff. A Dwarf's default measures **387.5** DPS against an Orc's 400.9, **−3.3%** (20,000
  fights on seed 2701, 1.60.1.70009; GV-8): the next-rank mail and the race together. *Effect:* Alliance only.
