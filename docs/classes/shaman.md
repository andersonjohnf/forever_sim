...
1. **Maelstrom Weapon's chance a hit.** The tooltip describes a chance but never shows it: it
   ...
   chance, 50% per landed melee hit (white, special and extra attacks) [?], a question for the user;
   no allowed source states the rate
