...
/**
 * A talent's name, rank and texts, and why a point can't be added or removed, in the notice colour
 * with an icon. `named` false leaves out the name and rank line, for the wide tab's detail panel,
 * which has its own heading.
 */
export function TalentDetails({
  ...
  return (
    <div className="flex flex-col gap-2 text-sm">
      ...
      {reasons.map((r) => (
        <p key={r.text} id={r.id} className="flex items-start gap-1.5 font-medium text-notice">
