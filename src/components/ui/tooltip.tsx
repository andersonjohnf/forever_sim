  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        {/*
         * forever_sim (docs/ux.md#visual-language "Tooltips"): a tooltip takes the popover's colours in
         * both themes, with a border and a light shadow, rather than shadcn's inverted foreground box (a
         * white box in the dark theme). The arrow is the same surface, edged on its two outer sides.
         */}
