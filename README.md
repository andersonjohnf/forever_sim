...
It runs entirely in your browser (no server), hosted on Firebase Hosting:
...
One-time setup: the Workload Identity Federation provider and deploy service account that section
names, and the `firebase` environment limited to `main`.
