...
// `paladin.retribution.` for Retribution). Values are numbers, true/false, or a choice's value. A
// candidate's settings are separated by commas. `--base` changes the baseline from the spec's
...
//   --spec warrior-arms   the spec (a SpecId with rotation settings: warrior-fury, warrior-arms, druid-feral-cat, paladin-retribution)
