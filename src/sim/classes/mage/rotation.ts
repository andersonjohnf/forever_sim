    ...
    cooldowns: [
      {
        ...
        help: 'Use Berserking (Troll: +10% casting speed for 10 s), Blood Fury (Orc: +10% spell power for 15 s) or Eureka! (Gnome: the next 3 of the spells it covers cost 50% less, and all but Arcane Missiles deal 10% more) on cooldown from the pull.',
        default: true,
      },
      {
        kind: 'toggle',
