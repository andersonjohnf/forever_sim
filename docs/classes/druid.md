...
- **The rage.** Every clean landed Maul left the bear 3.0 rage more than a 15-rage Maul would (10 of
  ...
  from the build, gives Maul no extra rage. Confirming the bear's talents closes it (Q39).
...
- "Causes a high amount of threat": **+206 per landed application** [?], by
  ...
  - Season of Discovery's Lacerate is the same spell (Forever's rank 1 reuses its spell id and its
    ...
    threat than the warrior and 84% more than the paladin (Q15).
...
- **Plausibility (D29, milestones T6).** D29 sets no numeric benchmark for a tank: the headlines
  ...
  **752.6**. The order has turned over: on 1.60.1.69913 the warrior's Balanced led (1,241 against
  ...
  none, 11.25 rage a bear swing from the beta logs, a raid druid's Thorns at 47 from a pre-raid
  Restoration druid's 313 spell damage) the defaults make the bear **1,104.3 TPS**, the warrior
  989.9 and the paladin 750.5 (seed 1, 10,000 fights): the bear 11.6% above the warrior and 47.1%
  above the paladin, no tank at twice another (main had the bear 1,102.4, the warrior 985.3 and the
  paladin 746.8). Each move is a cited value's (Lacerate's flat 206 −1.7%, the bear's rage +1.5%,
  Thorns 38 → 47 about +0.5% for every tank), none a target. Two Season of Discovery values were
  weighed and not adopted (§4.2, §4.3, Q15): Primal Bite's ×1.5 would put the bear about 20% above
  the warrior, and Lacerate's 3.33 × damage 40% above it (1,383.4 TPS). The paladin gap is the
  widest and stays an open question for in-game tests.
...
3. **The head, re-picked 2026-09-26.** Step 1's Darkmantle Cap is a rogue's: Dungeon Set 2's pieces
   ...
   factions wear it. Against Darkmantle Cap (seed 424242, 20,000 fights), measured on the earlier model,
   before the bear's 2026-09-26 threat and rage values (Lacerate's flat 206, 11.25 rage a white swing,
   a raid druid's Thorns at 47.04; §4.3, [rage.md](../mechanics/rage.md)): every figure in this step is
   that model's.
...
| Q39 | Maul's rage: the user's test bear gained 3.0 more on every landed Maul than a 15-rage Maul explains. Is that Ferocity 3/5 (a 12-rage Maul), or rage Forever gives back? | One Maul went off at 12.0 rage, which a 15-rage Maul can't, and the dodged Maul cost 20% of 12: both say a 12-rage Maul, Ferocity 3/5 at level 12 ([§4.1](#mauls-threat-and-rage-in-the-users-test-)). The sim gives no extra rage. The log's cost field reads 15 either way | The user: were three points in Ferocity? At 60, with Ferocity 5/5, Maul should cost 10 net: log 30+ Mauls between white swings as [rage.md](../mechanics/rage.md#mauls-rage-in-the-users-test-) does |
