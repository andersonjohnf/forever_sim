...
describe('specs', () => {
  it('offers only finished specs: Fury since M2.2c, Arms since M2.3c, Protection since P2, the Feral cat since B2, Retribution since C2, the Protection paladin since C3, the Feral bear since B4, Enhancement since S1, the three rogues since R1, the three mages since K2 and the warlocks since K3 (docs/ux.md principle 8), with every spec’s metadata', () => {
