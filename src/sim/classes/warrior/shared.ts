...
export const cooldownOptions = (ids: SharedIds): RotationOption[] => [
  {
    ...
    help: 'Use your race’s cooldown: Blood Fury (Orc), Berserking (Troll), Elune’s Light (Night Elf) or Eureka! (Gnome: the next 3 of the attacks it covers cost 10% less rage and deal 10% more).',
    default: true,
  },
  {
    kind: 'toggle',
    ...
    help: 'Use Weakness Analyzer (+5% crit until your next crit, for up to 20 s) and Earthstrike (+280 attack power for 20 s) if you wear them. Other on-use trinkets aren’t simulated.',
    default: true,
  },
  {
    kind: 'toggle',
