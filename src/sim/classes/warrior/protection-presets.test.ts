...
describe('the Protection warrior presets’ help numbers (FU-3)', () => {
  ...
  it('the help and the short lines quote them', () => {
    ...
    expect(help('defensive')).toContain('857 TPS, 386 DPS and 616 damage taken a second in the default setup')
    ...
    expect(help('default')).toContain('Against Defensive in the default setup: 6.2% more TPS, 5.8% more DPS and 21% more damage taken.')
