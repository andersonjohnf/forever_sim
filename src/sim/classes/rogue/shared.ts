...
export const cooldownOptions = (ids: RogueIds): RotationOption[] => [
  {
    ...
    help: 'Use Blood Fury (Orc, +10% attack power for 15 s), Berserking (Troll, +10% attack speed for 10 s), Elune’s Light (Night Elf, +10% crit for 15 s) or Eureka! (Gnome, the next 3 of the attacks it covers cost 20% less Energy and deal 10% more) on cooldown.',
    default: true,
  },
  {
    kind: 'toggle',
