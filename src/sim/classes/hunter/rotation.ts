    ...
    rows: [
      {
        ...
        optionIds: [],
        summary: [{ text: 'Aspect of the Hawk' }, { text: 'Trueshot Aura', requires: { talent: 'Trueshot Aura' } }],
      ...
      { id: 'huntersMark', label: 'Hunter’s Mark', icon: HUNTERS_MARK.icon, enabledId: ID.mark, optionIds: [], summary: [{ text: 'while it’s off the boss' }] },
      {
        ...
        summary: [
          { option: ID.sharedShot, text: '{}' },
          { option: ID.noClip, text: 'between Auto Shots', choiceIsNot: { option: ID.sharedShot, values: ['none'] } },
        ],
