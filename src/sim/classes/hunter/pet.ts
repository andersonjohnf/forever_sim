 ...
 * [?], inheriting from you as every pet does (ranged-and-pets.md §6, `PET_INHERITANCE` in
 * plan/pet.ts) [?]. Its list: Bite on cooldown, and Claw while its Focus is at least
