 ...
 * finisher talents on the Discord-tested attack-power shares, the two-roll abilities, Backstab's flat
...
export function rogueAssumptions(plan: Plan, talents: ReadonlyMap<string, number>): AssumptionId[] {
  ...
  // The poisons' attack-power shares come from a player's Discord tests [?]; how Deadly Poison reads it and which bonuses scale it are [?] (rogue.md §4.1, §4.2).
