...
export const ELEMENTAL_OPTIONS: RotationOption[] = [
  ...
  },
  {
    ...
    help: 'Drop it once all it restores fits: 290 mana every 3 s for 12 s, every 5 minutes.',
    default: true,
  ...
  },
  {
    ...
    help: 'With Clearcasting: only when Clearcasting makes its 485 mana free. On cooldown: whenever it’s ready, every 6 s. Against one boss it deals less than Lightning Bolt for far more mana.',
    choices: [
      { value: 'clearcasting', label: 'With Clearcasting' },
