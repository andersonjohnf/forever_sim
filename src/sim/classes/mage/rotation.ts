    ...
    cooldowns: [
      {
        ...
        help: 'Use Berserking (Troll: +10% casting speed for 10 s), Blood Fury (Orc: +10% spell power for 15 s) or Eureka! (Gnome: the next 3 of the spells it covers cost 10% less, and all but Arcane Missiles deal 10% more) on cooldown from the pull.',
        default: true,
      },
      {
        kind: 'toggle',
      ...
      },
      {
        ...
        help:
          spec === 'arcane'
            ? 'Take a priest’s Power Infusion, cast on you once: +20% spell damage for 15 s. It doesn’t stack with Arcane Power, so with Arcane Power on, it comes as Arcane Power ends; without it, at the pull.'
