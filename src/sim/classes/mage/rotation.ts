    ...
    cooldowns: [
      {
        ...
        help: 'Use Berserking (Troll: +10% casting speed for 10 s), Blood Fury (Orc: +10% spell power for 15 s) or Eureka! (Gnome: your next 3 spells cost 10% less, and all but Arcane Missiles deal 10% more) on cooldown from the pull.',
        default: true,
      },
      {
        kind: 'toggle',
