...
4. **Bear** [?]: Maul and Swipe multipliers (1.75), Demoralizing Roar (39) and Faerie Fire (108)
   ...
   1.60.1.70009's Sunder, 206 + 0.05 × AP, would give about 274 at the default bear's ~1,360 AP
   when its Lacerates land, for the druid slice to decide) and
